...
export const AppProvider = ({ children }) => {
    ...
    useEffect(() => {
        ...
        const unsubInv = onSnapshot(qInv, (snap) => {
            ...
            // Ordenar por nuestro timestamp pre-calculado (descendente)
        ...
        const unsubPol = onSnapshot(qPol, (snap) => {
            ...
            // Ordenar en memoria (descendente) por el campo más reciente disponible
            data.sort((a, b) => {
    ...
    const savePolicyResult = async (policyData, fileInfo) => {
        ...
        if (!snap.empty) {
            ...
            await updateDoc(existingDoc.ref, {
                ...
                // Guardado dual por compatibilidad de ordenamiento
            ...
            const newDoc = await addDoc(collection(db, 'policies'), {
                ...
                timestamp: serverTimestamp(), // Dual save
                updatedAt: serverTimestamp()
            });
