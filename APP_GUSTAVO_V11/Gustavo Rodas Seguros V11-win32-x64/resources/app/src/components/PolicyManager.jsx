    ...
    const filteredPolicies = useMemo(() => {
        ...
        return policies
            .filter(p => {
                ...
                // DEBUG LOG FOR MISSING POLICIES
                if (p.clientName?.toUpperCase().includes('GIL') || p.clientName?.toUpperCase().includes('OLIVARES')) {
                    console.log(`[DEBUG] Filter result for ${p.clientName}:`, {
                        matchesSearch, matchesRisk, matchesCompany, matchesAttachment, matchesStatus, matchesMissingFilter,
                        cancelled, expired, result,
                        searchTerm, filterStatus, filterRisk, filterCompany
                    });
                }
