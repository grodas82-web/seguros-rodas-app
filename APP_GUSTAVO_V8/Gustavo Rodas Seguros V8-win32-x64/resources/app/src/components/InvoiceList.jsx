                                    ...
                                    <tr key={inv.id} className="hover:bg-indigo-500/[0.02] transition-colors group">
                                        ...
                                        <td className={compact ? 'p-4' : 'p-8'}>
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p className={`font-black text-zinc-100 uppercase tracking-tight mb-0.5 ${compact ? 'text-xs' : ''}`}>
                                                        {inv.company?.toUpperCase().includes('MERCANTIN') || inv.company?.toUpperCase().includes('MERCANTIL')
                                                            ? 'MERCANTIL'
                                                            : inv.company}
                                                    </p>
                                                    <p className={`text-[10px] font-bold tracking-widest uppercase ${inv.cuit === '23294824979' ? 'text-rose-500' : 'text-zinc-600'}`}>
                                                        {inv.cuit === '23294824979' ? '⚠️ CUIT DEL EMISOR (IGNORADO)' : `CUIT: ${inv.cuit || 'N/D'}`}
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
